...
final class Token {
	...
	public enum Kind {
		...
		ARRAY("array"), BEGIN("begin"), CONST("const"), DO("do"), DoWhileDo("loop"), ELSE("else"), END("end"), FUNC("func"), IF("if"), IN("in"), LET("let"), OF("of"),
		PROC("proc"), REPEAT("repeat"), RECORD("record"), THEN("then"), TYPE("type"), UNTIL("until"), VAR("var"), WHILE("while"),
